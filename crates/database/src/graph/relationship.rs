...
pub enum RelationshipType {
    ...
    #[strum(serialize = "DEFINITION_DEFINES_ENDPOINT")]
    DefinitionDefinesEndpoint,
    #[strum(serialize = "FILE_HAS_ENDPOINT")]
    FileHasEndpoint,
    // Service call relationships
    #[strum(serialize = "DEFINITION_CALLS_SERVICE")]
    DefinitionCallsService,
    #[strum(serialize = "FILE_HAS_SERVICE_CALL")]
    FileHasServiceCall,
