...
pub(in crate::java) type AstRootNode = AstGrep<StrDoc<SupportLang>>;
...
pub enum JavaDefinitionMetadata {
    ...
    Field {
        field_type: JavaType,
        annotations: Vec<JavaAnnotation>,
        initializer: Option<String>,  // Field initializer value (e.g., "\"value\"" or "Constant.OTHER")
        modifiers: Vec<String>,        // Modifiers like "public", "static", "final"
    },
    LocalVariable {
